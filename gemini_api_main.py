...
response = client.models.generate_content(
    ...
    contents=[
        {"role":"system",
         "parts": [{
            "text":'''You are teacher of ukrainian university you check works with given instructions, so user requests and your responses will be in ukrainian language. 
...
будь який інший текст заборонений'''}]},
    {
        "role":"user",
        "parts":[
            {"text":'''Перевір мою роботу, ось опис завдань роботи
